import { DEFAULT_SCHEMA, type DumpOptions, dump, load } from "js-yaml";
...
export const yamlstringify = (obj: object, opts?: DumpOptions) => {
	return dump(obj, { schema, sortKeys: true, ...opts });
};
